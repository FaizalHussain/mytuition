...
echo $this->Html->script('faq', false);
?>
    <!-- Contents here -->
    <div id="home" style="text-align: justify">
        ...
        <p><h3><small><b>To begin your search for a tutor, you may choose to complete our Request Tutorform, alternatively you may contact us at the following:</b></small></h3></p>
                    ...
                    <li><h4><a id="showA1" href="#"> 1. How do I request for a tutor?</a></h4>
                        <ul style="padding-left: 20px;" id="a1">
                            <li><h4><small><b>
                                        ...
                                        Alternatively, if you are facing certain difficulty or feel more comfortable speaking to us over the phone, feel free to contact our friendly tuition coordinators @ 8444 0210.
                    ...
                    <li><h4><a id="showA4" href="#">4. How much commission does Straits Tutors charge?</a></h4>
                        <ul style="padding-left: 20px;" id="a4">
                            <li><h4><small><b>
                                            ...
                                            <span style="text-decoration: underline">Example</span><br/><br/>
                                            Parent A has requested for his child to have lessons 2 times a week, each lesson lasting 2 hours. The number of weeks in a month is set at 4 weeks. The hourly rate agreed upon is $25/hr.
                                            <br/><br/>
                                            The total tuition fee for the month is $400. (2 x 2 hours x 4 weeks x $25)
                                            <br/><br/>Therefore, for the first month only, Straits Tutors will collect $200 from you. (The remaining $200 will be paid to the tutor directly.
                    ...
                    <li><h4><a id="showA6" href="#">6. How do I pay Straits Tutors the commission for the tuition assignment?</a></h4>
                        <ul style="padding-left: 20px;" id="a6">
                            <li><h4><small><b>
                                            ...
                                            The details on how to make the payment will be communicated to you through the invoice. Our tuition coordinators will also contact you via phone to advise you on the payment details.<br/><br/>
                                            <span style="text-decoration: underline">It is important to note that tutors are not authorized to collect the commission on behalf of Straits Tutors. Payment of commission is only between the parent and Straits Tutors, and the parent will pay the commission directly to Straits Tutors.
                                            </span>
                    ...
                    <li><h4><a id="showA7" href="#">7. What happens if I find the tutor to be unsuitable on the first lesson?</a></h4>
                        <ul style="padding-left: 20px;" id="a7">
                            <li><h4><small><b>
                                            ...
                                            Kindly take note that in such a case, the lesson(s) conducted by the tutors will still be chargeable. 50% of the lesson(s) fee payable the tutor and the other 50% payable to Straits Tutors.
                    ...
                    <li><h4><a id="showB2" href="#">2. How do I register as a tutor with Straits Tutors?</a></h4>
                        <ul style="padding-left: 20px;" id="b2">
                            <li><h4><small><b>
                                            ...
                                            After registering for an account, you will be able to fill up your personal particulars and tuition preferences inside your personal Tutor’s Profile. Our Tuition Coordinators will also contact via phone to allow us to better understand your preferences as a tutors, as well as to answer any queries that you may have.
                                            It is good to take note that the completeness of your Tutor’s Profile will improve your chances of being shortlisted for future tuition assignments.
                                        </b></small></h4></li>
                        </ul>
                    </li>
                    <br>
                    <li><h4><a id="showB3" href="#">3. Is there any cost involved in signing up for an account?</a></h4>
                        <ul style="padding-left: 20px;" id="b3">
                            <li><h4><small><b>
                                            ...
                                            We only levy a commission of 50% of the first month’s tuition fee for every successful assignment match-up.
                                        </b></small></h4></li>
                        </ul>
                    </li>
                    <br>
                    <li><h4><a id="showB4" href="#">4. Upon registering for a Tutor’s Account, how long does it take for me to be given tuition assignments?</a></h4>
                        <ul style="padding-left: 20px;" id="b4">
                            <li><h4><small><b>
                                    ...
                                    However, it is good to take note of the following to improve your chances of being shortlisted for future assignments:<br/>
                                    •	Submit a clear photograph of yourself<br/>
                                    •	Ensure that your Tutor’s Profile is completed and up to date.<br/>
                                    •	Increase the number of areas that you are willing to tutor at<br/><br/>
                                    If you have further queries, kindly speak to any of our Tuition Coordinators via our hotline.
                            </b></small></h4></li>
                        </ul>
                    </li>
                    <br>
                    ...
                    <li><h4><a id="showB6" href="#">6. How much commission does Straits Tutors charge?</a></h4>
                        <ul style="padding-left: 20px;" id="b6">
                            <li><h4><small><b>
                                    Straits Tutors would collect 50% of the first month’s fee as commission for each successful match-up. The following example illustrates how the commission is calculated:<br/><br/>
                                    <span style="text-decoration: underline">Example</span><br/><br/>
                                    Parent A has requested for his child to have lessons 2 times a week, each lesson lasting 2 hours. The number of weeks in a month is set at 4 weeks. The hourly rate agreed upon is $25/hr.<br/><br/>
                                    The total tuition fee for the month is $400. (2 x 2 hours x 4 weeks x $25)<br/><br/>
                                    Therefore, for the first month only, the parent will pay you $200 for your services. The parent of the student will pay the other half directly to Straits Tutors.<br/><br/>

                                    It is important to note that tutors are not authorized to collect the commission on behalf of Straits Tutors. Payment of commission is only between the parent and Straits Tutors, and the parent will pay the commission directly to Straits Tutors.
                    ...
                    <li><h4><a id="showB8" href="#">8. What happens if the parent of the student finds me unsuitable on the first lesson?</a></h4>
                        <ul style="padding-left: 20px;" id="b8">
                            <li><h4><small><b>
                                            ...
                                            <br/><br/>Kindly take note that in such a case, the lesson(s) you have conducted will still be paid to you. Parents will pay 50% of the lesson(s) to you(tutor) and the other 50% paid to Straits Tutors as commission.
